  ...
  <body>
    ...
    <div class="containers">
      ...
      <div class="header" style="background:#007BFF">
        <br>
        <center> <img class="img-responsive" src="https://jawcenter.org/logo-dark.png"> </center>
      </div>
      ...
      <div class="row" style="margin: 0px">
        ...
        <div class="col-md-9" style="background-color: white">
          <br>
          <h2 style='font-family:"Arial Black", Gadget, sans-serif'>Name Your Repository</h2>
